	        ...
	        if (err) {
            	...
            	slack.api("channels.list", function(err, response) {
        			if (err) {
        				...
        				if (!slack_channel) {
        					logger.error(logPrefix + "Slack channel with name '" + checked_channel_name + "' existing but not accessible/not found in channel list.");
        					callback("Error: Slack channel with name '" + checked_channel_name + "' existing but not accessible/not found in channel list.");
        				} else {
